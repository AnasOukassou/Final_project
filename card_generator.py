...
def completed_number(prefix, length, rnd):
    """
...
def credit_card_number(type_cc, howMany = 1):
    ...
    while len(result) < howMany:
        ...
        result.append(str(completed_number(ccnumber, length, generator))[:-2])
